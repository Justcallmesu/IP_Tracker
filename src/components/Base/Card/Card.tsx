...
export function Card({ APIData }: { APIData: IPData }) {
	...
	return (
		<main className="w-4/5 md:h-42 bg-white shadow-[0_0_30px_-10px_rgba(0,0,0,0.3)] z-10 rounded-xl flex flex-col lg:flex-row justify-stretch gap-10 absolute top-[35%] text-[#969696] py-10 px-10">
